...
import 'package:komisains_app/modules/profile/bloc/kom_profile_bloc.dart';
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              BlocBuilder<KomProfileBloc, KomProfileState>(
                builder: (context, state) {
                  if (state is KomProfileStateLoad) {
                    return Center(
                      child: CircularProgressIndicator(),
                    );
                  } else if (state is KomProfileStateLoaded) {
                    return Column(
                      children: <Widget>[
                        Container(
                        ...
                        Padding(
                          ...
                          child: Html(
                            data: state.komProfile.description,
                          ),
                        ),
                      ],
                    );
